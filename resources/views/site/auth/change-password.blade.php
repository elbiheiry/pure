                ...
                <div class="row justify-content-center">
                    <div class="col-md-9">
                        ...
                        <div class="login-register-box">
                            <form class="form login-ajax" action="{{route('site.change-password',['id'=>$member->id,'hash'=>$hash])}}" method="post" >
                                {!! csrf_field() !!}
                                <div class="row">
                                    <div class="col-sm-6">
                                    ...
                                    <div class="col-sm-6">
                                        <div class=" form-group input-icon">
                                            <i class="far fa-envelope"></i>
                                            <input class="form-control" placeholder="@lang('login.confirm')" name="password_confirmation" type="password">
                                        </div>
                                    </div><!--End col-->
                                </div><!--End row-->
